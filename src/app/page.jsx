    ...
    <div className="min-h-screen">
      ...
      <div className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6 md:px-8 max-w-4xl mx-auto">
          <h1
            className="text-4xl md:text-6xl lg:text-7xl font-medium text-white mb-6 tracking-tight animate-fade-in-up"
          ...
          <h2
            className="text-2xl md:text-4xl font-light text-white/95 mb-12 tracking-wide animate-fade-in-up stagger-2"
            style={{ fontFamily: 'var(--font-display)' }}
          >
            FamDishとは
          </h2>

          <p className="text-lg md:text-xl text-white/90 leading-relaxed max-w-2xl mb-12 animate-fade-in-up stagger-3" style={{ fontFamily: 'var(--font-body)' }}>
            献立を考える手間をなくしたい。
            <br />
            食べたいものが食卓に出てくると嬉しい。
            <br />
            食材の無駄やマンネリ化をなくしたい。
            <br />
            <span className="text-[var(--gold-400)] font-medium">そんな悩みを解決。</span>
          </p>
