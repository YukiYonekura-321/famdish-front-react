  ...
  return (
    <div className="min-h-screen overflow-hidden aurora">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div
          className="absolute top-20 right-[18%] w-80 h-80 rounded-full blur-3xl opacity-18 floating"
          style={{
        ...
        ></div>
        <div
          className="absolute bottom-32 left-[22%] w-72 h-72 rounded-full blur-3xl opacity-20 floating"
          style={{
      ...
      <div className="relative min-h-screen flex items-center justify-center p-6">
          ...
          <div className="p-10 sm:p-14">
            <div className="text-center mb-8 animate-fade-in-up stagger-1">
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-full mb-5 floating"
                   style={{
                     background: "linear-gradient(135deg, rgba(212, 175, 55, 0.15), rgba(90, 122, 90, 0.15))",
            ...
            <p className="text-center text-muted mb-10 animate-fade-in-up stagger-3">
              Give your family a unique name that represents your household
            </p>
        ...
        <div className="fixed bottom-8 left-1/2 -translate-x-1/2 text-center animate-fade-in">
          <p className="text-xs text-muted">
            💫 This will be the name your family members see
          </p>
        </div>
      </div>
    </div>
